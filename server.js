...
app.get('/api/wspeed/health', (_req, res) => {
  res.json({
    ok: true,
...
app.get('/', (_req, res) => {
  res.json({ ok: true, service: 'Daily Quest W Speed backend' });
});

app.listen(process.env.PORT || 3000, () => console.log('W Speed backend ready'));
